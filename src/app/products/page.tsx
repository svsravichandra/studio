...
const products = [
  ...
  { name: 'Mountain Pine', description: 'A crisp scent of pine needles and fresh mountain air.', price: '8.00', image: 'https://placehold.co/400x400.png', hint: 'pine soap' },
  { name: 'Coastal Driftwood', description: 'Salty sea air mixed with the warm, earthy scent of driftwood.', price: '9.00', image: 'https://placehold.co/400x400.png', hint: 'beach soap' },
  { name: 'Spiced Tobacco', description: 'A rich blend of tobacco leaf, spices, and a hint of vanilla.', price: '9.00', image: 'https://placehold.co/400x400.png', hint: 'tobacco soap' },
  { name: 'Black Pepper & Birch', description: 'A bold, spicy scent with a woody backbone of birch.', price: '8.00', image: 'https://placehold.co/400x400.png', hint: 'pepper soap' },
];
      ...
      <div className="container mx-auto px-4 py-16">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8 text-left">
          {products.map((product) => (
            <div key={product.name} className="bg-card border border-border/50 rounded-lg flex flex-col overflow-hidden shadow-lg hover:shadow-primary/20 transition-shadow duration-300">
